...
level1Des = "Copy all of the text from the current Notepad window, create a new text document, and then paste it into the new Notepad window"
...
level1Actions = [{'app':'Notepad.exe', 'fileName': 'WastedTime'}, 'WastedTime - Notepad', db.getShortcutByName("selectAll"), db.getShortcutByName("copy"), "Untitled - Notepad", db.getShortcutByName("openNewWindow"), db.getShortcutByName("paste")]
