...
class Listener():
	...
	def __init__(self, file, validKeys):
		...
		for i in self.validShortcuts:
			print(i.getKeys())
		shuffle(self.totalShortcuts)
...
listen = Listener('user_output.txt', shortcutdatabase.getShortcutDatabaseList())
listen.start()
print("is it still listening?")